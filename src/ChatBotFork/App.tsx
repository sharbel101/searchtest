...
function App() {
  ...
  const flow: Flow = {
    ...
    ask_token: {
      message: () =>
        'Before we proceed, we need to verify your profile id, ' +
    ...
    ask_age_group: {
      message: () =>
        `Hey ${name}!, Your account got verified, May i know your age group?`,
    ...
    ask_favourite_pet: {
      ...
      function: (params: Params) =>
        alert(`You picked: ${JSON.stringify(params.userInput)}!`),
      chatDisabled: true,
      path: 'ask_height',
    },
    ask_height: {
    ...
    ask_weather: {
      ...
      component: (
        ...
        >
          <button className="secret-fav-color" onClick={() => alert('black')}>
            Click me!
          </button>
        </div>
      ),
    ...
    close_chat: {
      message:
        "I went into hiding but you found me! Ok tell me, what's your favourite food?",
      path: 'ask_image',
    },
    ask_image: {
      message: (params: Params) =>
