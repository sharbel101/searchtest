...
import { D_Private_Equity_Flow } from '@/components/Zustand store data/fs/Departement/D_PrivateEquity';
import { D_Ideation_Phase_FLow } from '@/components/Zustand store data/fs/Departement/D_IdeationPhase';
import { D_Early_VC_Flow } from '@/components/Zustand store data/fs/Departement/D_EarlyVC';
import { D_Angel_Phase_Flow } from '@/components/Zustand store data/fs/Departement/D_AngelPhase';
import { D_Advanced_VC_Flow } from '@/components/Zustand store data/fs/Departement/D_AdvancedVC';
