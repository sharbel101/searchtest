...
export const F_Private_Equity_Flow = {
  q1: {
  ...
  q2: {
    ...
    fields: {
      yoyGrowth: {
        ...
        nextField: null,
        options: [
          { id: 'under_10', value: '< 10%' },
          { id: '10_to_25', value: '10-25%' },
          { id: 'over_25', value: '> 25%' },
        ],
        validation:
  ...
  q3: {
    ...
    fields: {
      ...
      netResult: {
        ...
        nextField: null,
        options: [
          { id: 'loss_over_10', value: 'Loss greater than 10% of revenue' },
          { id: 'loss_10_to_0', value: 'Loss between 10% and 0%' },
          { id: 'break_even', value: 'Break-even or profit <15%' },
          { id: 'profit_over_15', value: 'Profit > 15%' },
        ],
        validation:
  ...
  q4: {
    ...
    fields: {
      opexRatio: {
        ...
        options: [
          { id: 'over_60', value: '> 60% of revenue spent on OpEx' },
          { id: '30_to_60', value: '30-60% of revenue spent on OpEx' },
          { id: 'under_30', value: '< 30% of revenue spent on OpEx' },
        ],
        validation:
  ...
  q5: {
    ...
    fields: {
      burnRate: {
        ...
        nextField: null,
        options: [
          { id: 'over_80', value: '>80% of revenue' },
          { id: '40_to_80', value: '40%-80% of revenue' },
          { id: 'under_40', value: '<40% of revenue' },
        ],
        validation:
  ...
  q6: {
    ...
    fields: {
      currentRatio: {
        ...
        options: [
          { id: 'under_1_8', value: '< 1.8' },
          { id: '1_8_to_2_5', value: '1.8 - 2.5' },
          { id: 'over_2_5', value: '> 2.5' },
        ],
        validation:
