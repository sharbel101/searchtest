  ...
  q1: {
    ...
    fields: {
      valuationBracket: {
        ...
        required: true,
        nextField: 'f5fc1473-9c54-41d4-b1db-f20781f9e2a7',
        placeholder: 'TBD',
  ...
  q3: {
    ...
    fields: {
      profitStatus: {
        ...
        required: true,
        nextField: '6a1cb488-eb6c-4fe4-850f-7ff180fc7de2',
        options: [
          {
            id: 'no',
            value: 'No',
      ...
      plStatement: {
        ...
        required: true,
        nextField: 'cdb991c1-71eb-4b02-9a74-8a469cff5cff',
        acceptedFiles: ['pdf', 'xlsx', 'xls'],
        validation:
  ...
  q4: {
    ...
    fields: {
      opexRatio: {
        ...
        required: true,
        nextField: 'a8e7dbaa-86f6-45a7-9ea6-c867af94c2cb',
        options: [
          {
            id: 'over_70',
  ...
  q6: {
    ...
    fields: {
      currentRatio: {
        ...
        required: true,
        nextField: '1e7db442-47a2-4a99-8ee5-475c7789bca6',
        options: [
          {
            id: 'under_1_5',
            value: '< 1.5',
  ...
  q8: {
    ...
    fields: {
      financingType: {
        ...
        required: true,
        nextField: '7e89ac32-8d1f-49bb-b4cd-b6c6c134c088',
        options: [
          {
            id: 'equity',
  ...
  q9: {
    ...
    fields: {
      arTurnover: {
        ...
        required: true,
        nextField: 'eab2a595-ed81-4384-9399-ef4030550287',
        options: [
          {
            id: 'slow_collection',
      ...
      auditReport: {
        ...
        required: true,
        nextField: 'a55badef-3d0c-4e7c-b812-fc00fae93795',
        acceptedFiles: ['pdf'],
        validation:
