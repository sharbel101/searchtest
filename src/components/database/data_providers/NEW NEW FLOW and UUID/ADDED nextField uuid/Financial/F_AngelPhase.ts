  ...
  q1: {
    ...
    fields: {
      valuationBracket: {
        ...
        required: true,
        nextField: 'fcb2e3c3-5122-4a48-8ad5-a18273717467',
        placeholder: 'TBD',
  ...
  q3: {
    ...
    fields: {
      profitTimeline: {
        ...
        required: true,
        nextField: '002d6905-f6a7-4b4a-a7cf-9e526c048f08',
        options: [
          {
            id: 'over_5_years',
      ...
      projectedResult: {
        ...
        required: true,
        nextField: '51630a94-2c1a-4c91-8ea4-2f1a63043909',
        options: [
          {
            id: 'loss_over_50',
  ...
  q4: {
    ...
    fields: {
      projectedOpex: {
        ...
        required: true,
        nextField: '35f9aa6a-f678-401c-ab1d-579b7bf20fd8',
        options: [
          {
            id: 'over_90',
  ...
  q6: {
    ...
    fields: {
      estimatedCurrentRatio: {
        ...
        required: true,
        nextField: 'ddd0da4d-693b-4c54-a7b7-ead1056af43c',
        options: [
          {
            id: 'under_1',
            value: '< 1.0',
  ...
  q9: {
    ...
    fields: {
      arTurnover: {
        ...
        required: true,
        nextField: 'c65c11f8-f353-4164-bb2f-958e13f0b4cb',
        options: [
          {
            id: 'slow_collection',
      ...
      auditReport: {
        ...
        required: true,
        nextField: 'b9884493-28e5-45b2-a580-f33feb995595',
        acceptedFiles: ['pdf'],
        validation:
