  ...
  q1: {
    ...
    fields: {
      valuationBracket: {
        ...
        required: true,
        nextField: 'e4a20170-a296-4e2c-9a0a-b77668c14ba2',
        placeholder: 'TBD',
  ...
  q3: {
    ...
    fields: {
      profitStatus: {
        ...
        required: true,
        nextField: 'f34ef3b6-5f83-46ec-a2f8-47c55dc1de2b',
        options: [
          {
            id: 'no',
            value: 'No',
      ...
      plStatement: {
        ...
        required: true,
        nextField: '2c491a75-c0ba-4266-ab60-3d6dd6189266',
        acceptedFiles: ['pdf', 'xlsx', 'xls'],
        validation:
      ...
      profitTimeline: {
        ...
        required: true,
        nextField: '1cde9608-9213-4925-a10e-6a526ada33ac',
        options: [
          {
            id: 'over_4_years',
  ...
  q4: {
    ...
    fields: {
      opexRatio: {
        ...
        required: true,
        nextField: '88a243cb-d466-4659-a593-37195fba2b5e',
        options: [
          {
            id: 'over_80',
  ...
  q6: {
    ...
    fields: {
      currentRatio: {
        ...
        required: true,
        nextField: '5737b175-0589-45ab-af9d-2be3888e23aa',
        options: [
          {
            id: 'under_1_2',
            value: '< 1.2',
  ...
  q8: {
    ...
    fields: {
      financingType: {
        ...
        required: true,
        nextField: '550deb23-9a1d-4eb8-b8a1-3c212bce98a9',
        options: [
          {
            id: 'debt',
  ...
  q9: {
    ...
    fields: {
      arTurnover: {
        ...
        required: true,
        nextField: 'ab2b1396-0710-4d54-8a1b-f3bf82d18879',
        options: [
          {
            id: 'slow_collection',
      ...
      auditReport: {
        ...
        required: true,
        nextField: 'aceaa4a4-f5c0-4c61-8a46-cda1bd19e52f',
        acceptedFiles: ['pdf'],
        validation:
