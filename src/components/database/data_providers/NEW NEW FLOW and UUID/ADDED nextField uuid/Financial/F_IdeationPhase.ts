  ...
  q1: {
    ...
    fields: {
      valuationBracket: {
        ...
        required: true,
        nextField: '0f7cf2e8-5200-49d0-9110-67d459d2dfd6',
        placeholder: 'TBD',
  ...
  q2: {
    ...
    fields: {
      revenueStarted: {
        ...
        required: true,
        nextField: '336337bd-b6b4-469d-af87-0cfcf064fb22',
        options: [
          {
            id: 'no',
            value: 'No, not yet',
      ...
      expectedGrowth: {
        ...
        required: true,
        nextField: 'b5fa0059-7598-47f8-96fd-6bade2555c89',
        options: [
          {
            id: 'under_50',
            value: '< 50%',
  ...
  q3: {
    ...
    fields: {
      breakEvenTime: {
        ...
        required: true,
        nextField: '7bc19ce4-4f99-4aaf-860e-da6ed7ff6cf5',
        options: [
          {
            id: 'over_5_years',
  ...
  q4: {
    ...
    fields: {
      projectedOpex: {
        ...
        required: true,
        nextField: '5be7d496-38e7-4c81-b6ff-2200daba65c9',
        options: [
          {
            id: 'over_100',
  ...
  q6: {
    ...
    fields: {
      projectedCurrentRatio: {
        ...
        required: true,
        nextField: '7d1dbb78-cf9a-45ec-be1e-383629803b33',
        options: [
          {
            id: 'under_1',
            value: '< 1.0',
  ...
  q8: {
    ...
    fields: {
      financingHistory: {
        ...
        required: true,
        nextField: '6cd8f20d-c176-49b3-b3e5-503a6fd4a6c0',
        options: [
          {
            id: 'none',
            value: 'No',
