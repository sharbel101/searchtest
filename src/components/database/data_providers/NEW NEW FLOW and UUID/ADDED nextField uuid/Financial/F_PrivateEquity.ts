  ...
  q1: {
    ...
    fields: {
      valuationBracket: {
        ...
        required: true,
        nextField: '1d0aa6ab-e9dd-459c-8175-7cc3ee3e5a5d',
        placeholder: 'TBD',
  ...
  q3: {
    ...
    fields: {
      profitStatus: {
        ...
        required: true,
        nextField: '19d7002f-07d3-483f-be42-8a80da561e08',
        options: [
          {
            id: 'no',
            value: 'No',
      ...
      plStatement: {
        ...
        required: true,
        nextField: 'a3fa1d5c-fcc7-4972-b46a-626a4d88a95e',
        acceptedFiles: ['pdf', 'xlsx', 'xls'],
        validation:
  ...
  q4: {
    ...
    fields: {
      opexRatio: {
        ...
        required: true,
        nextField: '8c93c8f2-a377-473e-bf0b-562dc165b107',
        options: [
          {
            id: 'over_60',
  ...
  q6: {
    ...
    fields: {
      currentRatio: {
        ...
        required: true,
        nextField: '43d15911-4624-4742-a65b-2421aa76439e',
        options: [
          {
            id: 'under_1_8',
            value: '< 1.8',
  ...
  q8: {
    ...
    fields: {
      financingType: {
        ...
        required: true,
        nextField: 'bff98ade-6b9b-4914-a084-e9cd80b9293e',
        options: [
          {
            id: 'equity',
  ...
  q9: {
    ...
    fields: {
      arTurnover: {
        ...
        required: true,
        nextField: '912c2044-7d00-442a-b2f4-9351134d4450',
        options: [
          {
            id: 'slow_collection',
      ...
      auditReport: {
        ...
        required: true,
        nextField: '30ff83da-7805-44c9-bd16-c551137d0a22',
        acceptedFiles: ['pdf'],
        validation:
