import { FieldType, FlowSection } from '../MainFlow/flow';
            ...
            options: [
              {
                id: 'no_formal_chart',
                value:
                  'No formal org chart, structure is still loosely defined',
              },
              {
                id: 'partial_chart',
                value:
          ...
          departmentReporting: {
            ...
            options: [
              ...
              },
              {
                id: 'mixed_reporting',
                value:
                  'Mixed reporting structure (some direct, some fragmented)',
              },
              {
                id: 'direct_reporting',
            ...
            options: [
              {
                ...
                value:
                  'No, all teams still report directly to senior executives',
              },
              {
      ...
      q8: {
        ...
        fields: {
          ...
          strategicDecisionInvolvement: {
            ...
            type: FieldType.Dropdown,
            label:
              'How involved is this executive in strategic decision-making?',
            required: true,
            options: [
              {
          ...
          departmentKpis: {
            ...
            options: [
              ...
              },
              {
                id: 'clear_kpis',
                value:
                  'Yes, department KPIs are defined, tracked, and optimized',
              },
            ],
          },
        },
      ...
      q11: {
        ...
        fields: {
          collaborationTools: {
            ...
            type: FieldType.Dropdown,
            label:
              'What tools or platforms are used for internal collaboration?',
            required: true,
            options: [
              {
                id: 'no_tools',
            ...
            options: [
              {
                id: 'no_reporting',
                value:
                  'No formal reporting system, performance tracking is ad hoc',
              },
              {
                id: 'some_reporting',
            ...
            options: [
              {
                id: 'not_prepared',
                value:
                  'The company is not structurally prepared for rapid growth',
              },
              {
          ...
          careerProgression: {
            ...
            options: [
              ...
              },
              {
                id: 'clear_paths',
                value:
                  'Clear promotion paths & professional development programs',
              },
            ],
          },
        },
