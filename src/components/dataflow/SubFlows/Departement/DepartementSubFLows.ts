import { FormField, FieldType, FlowSection } from '../../MainFlow/flow';

export type typeDepFlow = {
  [key: string]: { [key: string]: FlowSection };
};

export const DepartmentFlows: typeDepFlow = {
  AdvancedVC: {
    q1: {
    ...
    q4: {
      ...
      fields: {
        departmentReporting: {
          ...
          required: true,
          options: [
            { id: 'no_clear_reporting', value: 'No clear reporting structure' },
            {
              id: 'mixed_reporting',
      ...
      fields: {
        departmentsEstablished: {
          ...
          options: [
            ...
            { id: 'software_dev', value: 'Software Development & Engineering' },
        ...
        performanceReviewFrequency: {
          ...
          required: true,
          options: [
            { id: 'no_reviews', value: 'No structured performance evaluation' },
            { id: 'yearly', value: 'Once a year' },
